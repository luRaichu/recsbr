...
// Shovel Brigade
void ActNpc220(NPCHAR *npc) //TODO - make this accurate can't do it rn because my brain hurts
{
	RECT rcLeft[4] = {
		{0, 64, 16, 80},
		{16, 64, 32, 80},
	...
	switch (npc->act_no)
	{
		...
		/*case 3:
			if (++npc->act_wait > 8)
			{
				PlaySoundObject(155, SOUND_MODE_PLAY);
	...
	// Gravity
	npc->ym += 0x20;
	if (npc->ym > 0x5FF) //Speedcap cause why not
		npc->ym = 0x5FF;
