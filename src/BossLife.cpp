...
void PutBossLife(void)
{
	...
	RECT rcBox1 = {0, 184, 244, 192};
	RECT rcBox2 = {0, 200, 244, 208};
	...
	PutBitmap3(&grcGame, PixelToScreenCoord((WINDOW_WIDTH / 2) - 96), PixelToScreenCoord(WINDOW_HEIGHT - 224), &rcBox1, SURFACE_ID_TEXT_BOX);
	PutBitmap3(&grcGame, PixelToScreenCoord((WINDOW_WIDTH / 2) - 96), PixelToScreenCoord(WINDOW_HEIGHT - 216), &rcBox2, SURFACE_ID_TEXT_BOX);
	PutBitmap3(&grcGame, PixelToScreenCoord((WINDOW_WIDTH / 2) - 56), PixelToScreenCoord(WINDOW_HEIGHT - 220), &rcBr, SURFACE_ID_TEXT_BOX);
	PutBitmap3(&grcGame, PixelToScreenCoord((WINDOW_WIDTH / 2) - 56), PixelToScreenCoord(WINDOW_HEIGHT - 220), &rcLife, SURFACE_ID_TEXT_BOX);
	PutBitmap3(&grcGame, PixelToScreenCoord((WINDOW_WIDTH / 2) - 88), PixelToScreenCoord(WINDOW_HEIGHT - 220), &rcText, SURFACE_ID_TEXT_BOX);
